...
-- Этот скрипт исправляет все проблемы с доступом к таблице test_results
...
CREATE POLICY "Enable delete for authenticated users" ON test_results
...
-- 13. Проверяем структуру таблицы
