...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleYandexAuthSuccess = (event: CustomEvent) => {
      ...
      console.log('AuthProvider: Обновляем authState с новым пользователем:', user)
      console.log('AuthProvider: Новый ID пользователя:', user.id)
      ...
      console.log('AuthProvider: authState обновлен')
    }
